...
class WorkflowContext:
    ...
    transition_duration_seconds: Optional[float] = None  # Durée dans l'état précédent (pour analytics)
    actor_role:  str = ""
...
class WorkflowDefinition:
    ...
    def get_transition(self, from_state: str, to_state: str) -> Optional[TransitionDef]:
...
class WorkflowEngine:
    ...
    def can_transition(
        ...
        ctx = WorkflowContext(
            instance=instance, from_state=from_state, to_state=to_state,
    ...
    def transition(
        ...
        ctx = WorkflowContext(
            instance=instance, from_state=from_state, to_state=to_state,
            actor=actor, reason=reason, metadata=metadata or {},
            actor_role=role, request=request,
        ...
        instance.save(update_fields=[
            "workflow_state", "workflow_updated_at", "updated_by", "updated_at"
        ])
    ...
    def _compute_state_duration(self, instance, state: str) -> Optional[float]:
...
class TransitionResult:
    ...
    from_state: str
    to_state:   str
    transition: Optional[TransitionDef] = None
    log_entry:  Any = None
    error:      str = ""
