...
class UserAdmin(BaseUserAdmin, SimpleHistoryAdmin):
    ...
    fieldsets = (
        ...
        ("Rôle & Permissions", {"fields": ("role", "is_active", "is_staff", "is_superuser", "must_change_password")}),
        ("Groupes Django", {"fields": ("groups", "user_permissions"), "classes": ("collapse",)}),
        ("Métadonnées", {"fields": ("id", "last_login", "last_login_ip", "date_joined", "created_at", "updated_at"), "classes": ("collapse",)}),
