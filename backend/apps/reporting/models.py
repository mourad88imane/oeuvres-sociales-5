...
class KpiSnapshot(BaseModel):
    kpi = models.ForeignKey(KpiDefinition, on_delete=models.CASCADE, related_name="snapshots", verbose_name="KPI")
...
class ReportDefinition(BaseModel):
    ...
    description = models.TextField(blank=True, verbose_name="Description")
    category = models.CharField(max_length=20, choices=CATEGORIES, verbose_name="Catégorie")
    default_format = models.CharField(max_length=10, choices=FORMATS, default="excel", verbose_name="Format par défaut")
    filters_config = models.JSONField(default=dict, blank=True, verbose_name="Configuration des filtres")
    columns_config = models.JSONField(default=list, blank=True, verbose_name="Configuration des colonnes")
...
class ReportSchedule(BaseModel):
    ...
    report = models.ForeignKey(ReportDefinition, on_delete=models.CASCADE, related_name="schedules", verbose_name="Rapport")
    ...
    format = models.CharField(max_length=10, choices=ReportDefinition.FORMATS, default="excel", verbose_name="Format")
    export_format = models.CharField(max_length=10, choices=ReportDefinition.FORMATS, default="excel", verbose_name="Format d'export")
    is_active = models.BooleanField(default=True, verbose_name="Actif")
    ...
    filters_override = models.JSONField(default=dict, blank=True, verbose_name="Filtres personnalisés")
...
class DataExport(BaseModel):
    ...
    report = models.ForeignKey(ReportDefinition, on_delete=models.SET_NULL, null=True, blank=True, related_name="exports", verbose_name="Rapport")
    export_format = models.CharField(max_length=10, choices=ReportDefinition.FORMATS, verbose_name="Format")
    file = models.FileField(upload_to="exports/%Y/%m/", null=True, blank=True, verbose_name="Fichier")
    file_size = models.PositiveIntegerField(default=0, verbose_name="Taille (octets)")
    status = models.CharField(max_length=15, choices=STATUSES, default="pending", verbose_name="Statut")
