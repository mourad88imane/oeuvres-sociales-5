...
if HAS_NESTED:
    ...
    urlpatterns = [
        ...
        path("<uuid:employee_pk>/beneficiaries/", BeneficiaryViewSet.as_view({"get":"list","post":"create"}), name="beneficiary-list"),
        path("<uuid:employee_pk>/beneficiaries/<uuid:pk>/", BeneficiaryViewSet.as_view({"get":"retrieve","put":"update","patch":"partial_update","delete":"destroy"}), name="beneficiary-detail"),
    ]
