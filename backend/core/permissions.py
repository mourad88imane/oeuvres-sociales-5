...
class IsGestionnaire(BasePermission):
    ...
    def has_permission(self, request, view):
        return request.user.is_authenticated and request.user.role == Role.GESTIONNAIRE
...
class IsConsultant(BasePermission):
    ...
    def has_permission(self, request, view):
        return request.user.is_authenticated and request.user.role == Role.CONSULTANT
...
class IsAdminOrComptable(BasePermission):
    ...
    def has_permission(self, request, view):
        return request.user.is_authenticated and request.user.role in [Role.ADMIN, Role.COMPTABLE]
...
class IsStaff(BasePermission):
    ...
    def has_permission(self, request, view):
        return request.user.is_authenticated and request.user.role in Role.STAFF
